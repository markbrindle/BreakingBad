...
// Extract this data to a JSON file if time allows.  Used as a fallback if real data is unavailable
struct CharactersRawData {
    static func allCharacters() -> Data? {
        """
            [
                {
                    "char_id": 1,
